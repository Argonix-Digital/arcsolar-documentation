...
<Visibility for="humans">
One integration is built but not switched on for anyone yet: the BridgeSelect rebate submission service. It cannot be enabled from Settings, and it should not be promised to a customer. If you want it for your business, ask support.
</Visibility>
