...
<Visibility for="humans">
Open [**Settings → Account**](https://app.arcsolar.com.au/dashboard/settings?tab=account) to manage your own details.
...
<Visibility for="agents">
- Personal account controls live under **Settings → Account** (`/dashboard/settings?tab=account`). The page is titled **Settings** and described as "Manage your profile, appearance and account security."
