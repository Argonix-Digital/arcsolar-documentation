...
**Where:** [**Retailer Settings → Integrations → BridgeSelect**](https://app.arcsolar.com.au/dashboard/quoting-settings?tab=integrations). The card carries a **Beta** badge and a status label.
