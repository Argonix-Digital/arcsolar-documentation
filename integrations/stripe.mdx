...
---
**Open:** **Set up customer payments** during onboarding, or the Stripe card under [**Retailer Settings → Integrations**](https://app.arcsolar.com.au/dashboard/quoting-settings?tab=integrations), where available.
