...
Intelligence can help read a diagram and explain what a topology finding means. It cannot certify the drawing, verify the site, check protection coordination or approve an installation, and it cannot save or amend an SLD. Any real switchboard issue needs a qualified person's review.
