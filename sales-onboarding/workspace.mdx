...
1. Open [**Rep Overview**](https://app.arcsolar.com.au/dashboard/overview). Check the selected representative. Find appointments and work needing attention.
2. Open [**Tasks → My tasks**](https://app.arcsolar.com.au/dashboard/work-tasks). This is where you find follow-ups you own or are tagged in.
