...
1. Select [**Customers → Customer Records**](https://app.arcsolar.com.au/dashboard/customers).
...
Open [**Customers → Pipeline**](https://app.arcsolar.com.au/dashboard/customers/pipeline) and find the same customer. The stage should describe what has actually happened:
