...
<Frame caption="Build a practice quote. Pause the video and follow along in the demo.">
  <QuotingVideo label="Sales rep practice: create and review a quote in ArcSolar" />
</Frame>

[Watch full size](https://mintcdn.com/arc-solar/ECLoOeBu_2hQztaN/videos/quoting-walkthrough.mp4)
...
1. Open [**Quick Create Quote**](https://app.arcsolar.com.au/dashboard/quotes/new). Select the existing practice customer and opportunity.
